...
from src.pipeline.stage3_prefilter import prefilter_search_results
...
from src.pipeline.stage5_extract import extract_for_campaign
...
async def run_campaign(campaign_id: int) -> None:
    """Top-level orchestrator: stages 1 → 6.
